...
class _DermatologistProfilePageState
    extends State<DermatologistProfilePage> {
  ...
  // ✅ Photo : on stocke le base64, pas une URL
  String? _photoBase64;
  Uint8List? _photoBytes; // cache décodé pour l'affichage

  // ✅ Document : support base64 + URL legacy
  String? _docBase64;
  String? _docUrl;
  ...
  Future<void> _loadProfile() async {
    ...
    // Décoder la photo si elle existe
    ...
    setState(() {
      ...
      _docBase64 = data['professionalDocBase64'] as String?;
      _docUrl = data['professionalDocUrl'] as String?;
  ...
  Future<void> _pickAndUploadImage() async {
    try {
      ...
      // uploadProfilePicture retourne le base64 (pas une URL)
      final base64Str =
      await _authService.uploadProfilePicture(File(image.path));
      ...
      if (base64Str != null) {
        setState(() {
          ...
          _photoBytes = base64Decode(base64Str); // décoder pour affichage
          _isLoading = false;
        });
      } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
        ...
        child: Column(
          children: [
            // ✅ Photo de profil : Image.memory au lieu de NetworkImage
            Center(
              child: Stack(
                children: [
                  CircleAvatar(
            ...
            _buildInfoCard(
              ...
              items: [
                _buildInfoRow(Icons.badge_outlined, 'ONMC Number',
                    _onmcNumber),
                _buildInfoRow(
                    Icons.school_outlined, 'Degree', _degree),
            ...
            // ✅ Document : base64 en priorité, sinon URL legacy
            if (_docBase64 != null && _docBase64!.isNotEmpty)
              _buildInfoCard(
            ...
            else if (_docUrl != null && _docUrl!.isNotEmpty)
              _buildInfoCard(
                title: 'Supporting Document',
                items: [
                  const SizedBox(height: 10),
